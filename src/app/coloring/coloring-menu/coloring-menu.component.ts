...
export class ColoringMenuComponent implements AfterViewInit, OnInit, OnDestroy {
  ...
  public filesSelect($event: Event): void {
    this.coloringSettings.imageFiles = (
  ...
  public handleSize(): void {
    ...
    if (
      this.coloringSettings.sizesIndex >= this.coloringSettings.sizes.length
    ) {
  ...
  private _hideElements(skip: string): void {
    skip !== 'saveInfo' &&
      ColoringMenuComponent._hideElement(this._saveInfo.nativeElement);
    skip !== 'coloredInfo' &&
      ColoringMenuComponent._hideElement(this._coloredInfo.nativeElement);
    skip !== 'qualityInfo' &&
      ColoringMenuComponent._hideElement(this._qualityInfo.nativeElement);
    skip !== 'sizeInfo' &&
      ColoringMenuComponent._hideElement(this._sizeInfo.nativeElement);
  }
